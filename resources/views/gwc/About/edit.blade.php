...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>{{__('adminMessage.websiteName')}}|{{__('adminMessage.editAbout')}}</title>
			...
			<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							<div class="kt-container  kt-container--fluid ">
								<div class="kt-subheader__main">
									<h3 class="kt-subheader__title">{{__('adminMessage.About')}}</h3>
									<span class="kt-subheader__separator kt-hidden"></span>
									<div class="kt-subheader__breadcrumbs">
										<a href="{{url('gwc/home')}}" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
										<span class="kt-subheader__breadcrumbs-separator"></span>
										<a href="javascript:;" class="kt-subheader__breadcrumbs-link">{{__('adminMessage.editAbout')}}</a>
									</div>
								</div>
						...
						<div class="kt-portlet__head kt-portlet__head--lg">
									<div class="kt-portlet__head-label">
										...
										<h3 class="kt-portlet__head-title">{{__('adminMessage.editAbout')}}</h3>
									</div>
									<div class="kt-portlet__head-toolbar">
										<div class="kt-portlet__head-wrapper">
											<div class="kt-portlet__head-actions">

												<a href="{{url('gwc/About')}}" class="btn btn-brand btn-elevate btn-icon-sm"><i class="la la-list-ul"></i>{{__('adminMessage.listAbouts')}}</a>
											</div>
										</div>
									</div>
								</div>				
                    ...
                    <form name="tFrm"  id="form_validation"  method="post"
                          class="kt-form" enctype="multipart/form-data" action="{{route('About.update',$editAbout->id)}}">
                          <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                           ...
                                           <div class="form-group row">
                                                ...
                                                <label>{{__('adminMessage.menu_name_en')}}</label>
                                                        <input type="text" class="form-control @if($errors->has('menu_name_en')) is-invalid @endif" name="menu_name_en"
                                                               value="{{$editAbout->menu_name_en?$editAbout->menu_name_en:old('menu_name_en')}}" autocomplete="off" placeholder="{{__('adminMessage.enter_menu_name_en')}}*" />
                                                ...
                                                <label>{{__('adminMessage.menu_name_ar')}}</label>
                                                        <input type="text" class="form-control @if($errors->has('menu_name_ar')) is-invalid @endif" name="menu_name_ar"
                                                               value="{{$editAbout->menu_name_ar?$editAbout->menu_name_ar:old('menu_name_ar')}}" autocomplete="off" placeholder="{{__('adminMessage.enter_menu_name_ar')}}*" />
                                                ...
                                                <div class="form-group row">
													...
													<div class="col-3">
														<span class="kt-switch">
															<label>
																<input type="checkbox" {{ old('is_active', $editAbout->is_active) ? 'checked' : '' }} name="is_active"  id="is_active" value="1"/>
																<span></span>
															</label>
														</span>
													</div>
													...
													<div class="col-3">
														<input type="text" class="form-control @if($errors->has('display_order')) is-invalid @endif" name="display_order"  value="{{$editAbout->display_order?$editAbout->display_order:old('display_order')}}" autocomplete="off" />
                                       ...
                                       <!--categories name -->         
                                                ...
                                                <input type="text" class="form-control @if($errors->has('title_en')) is-invalid @endif" name="title_en"
                                                               value="{{$editAbout->title_en?$editAbout->title_en:old('title_en')}}" autocomplete="off" placeholder="{{__('adminMessage.enter_title_en')}}*" />
                                                ...
                                                <input type="text" class="form-control @if($errors->has('title_ar')) is-invalid @endif" name="title_ar"
                                                               value="{{$editAbout->title_ar?$editAbout->title_ar:old('title_ar')}}" autocomplete="off" placeholder="{{__('adminMessage.enter_title_ar')}}*" />
                                      ...
                                      <!--categories description -->          
                                            <div class="form-group row">
                                                ...
                                                <label>{{__('adminMessage.details_en')}}</label>
                                                        <textarea rows="3" id="details_en" name="details_en" class="kt-tinymce-4 form-control @if($errors->has('details_en')) is-invalid @endif" autocomplete="off" placeholder="{{__('adminMessage.enter_details_en')}}">{!!$editAbout->details_en?$editAbout->details_en:old('details_en')!!}</textarea>
                                                ...
                                                <label>{{__('adminMessage.details_ar')}}</label>
                                                        <textarea   rows="3" id="details_ar" name="details_ar" class="kt-tinymce-4 form-control @if($errors->has('details_ar')) is-invalid @endif" autocomplete="off" placeholder="{{__('adminMessage.enter_details_ar')}}">{!!$editAbout->details_ar?$editAbout->details_ar:old('details_ar')!!}</textarea>
                                      ...
                                      <div class="form-group row">
                                                ...
                                                <label>{{__('adminMessage.seokeywords_en')}}</label>
                                                        <textarea rows="3" name="seo_keywords_en" class="form-control @if($errors->has('seo_keywords_en')) is-invalid @endif" autocomplete="off" placeholder="{{__('adminMessage.enterseokeywords_en')}}">{{$editAbout->seo_keywords_en?$editAbout->seo_keywords_en:old('seo_keywords_en')}}</textarea>
                                                ...
                                                <label>{{__('adminMessage.seokeywords_ar')}}</label>
                                                        <textarea rows="3" name="seo_keywords_ar" class="form-control @if($errors->has('seo_keywords_ar')) is-invalid @endif" autocomplete="off" placeholder="{{__('adminMessage.enterseokeywords_ar')}}">{{$editAbout->seo_keywords_ar?$editAbout->seo_keywords_ar:old('seo_keywords_ar')}}</textarea>
                                    ...
                                    <div class="form-group row">
                                                ...
                                                <label>{{__('adminMessage.seodescription_en')}}</label>
                                                        <textarea rows="3" name="seo_description_en" class="form-control @if($errors->has('seo_description_en')) is-invalid @endif" autocomplete="off" placeholder="{{__('adminMessage.enterseodescription_ar')}}">{{$editAbout->seo_description_en?$editAbout->seo_description_en:old('seo_description_en')}}</textarea>
                                                ...
                                                <label>{{__('adminMessage.seodescription_ar')}}</label>
                                                        <textarea rows="3" name="seo_description_ar" class="form-control @if($errors->has('seo_description_ar')) is-invalid @endif" autocomplete="off" placeholder="{{__('adminMessage.enterseodescription_ar')}}">{{$editAbout->seo_description_ar?$editAbout->seo_description_ar:old('seo_description_ar')}}</textarea>
                                         ...
                                         <div class="form-group row">
                                                ...
                                                <div class="col-lg-2">
                                                @if($editAbout->bannerimage)
                                                <img src="{!! url('uploads/About/'.$editAbout->bannerimage) !!}" width="40">
                                                <a href="javascript:;" data-toggle="kt-popover" data-trigger="focus" title="{{__('adminMessage.alert')}}" data-html="true" data-content="{{__('adminMessage.areyousuretodelete')}}<br><br><a href='{{url('gwc/About/deleteAboutbImage/'.$editAbout->id)}}' class='btn btn-brand btn-danger btn-icon-sm btn-sm'>YES</a>" class="btn btn-brand btn-danger btn-icon-sm btn-sm"><i class="la la-trash"></i>{{__('adminMessage.delete')}}</a>
                                                @endif
                                                </div>
                                            </div>
											...
											<div class="kt-portlet__foot">
												<div class="kt-form__actions">
													...
													<button type="button" onClick="Javascript:window.location.href='{{url('gwc/About')}}'"  class="btn btn-secondary cancelbtn">{{__('adminMessage.cancel')}}</button>
												</div>
											</div>
										</form>
